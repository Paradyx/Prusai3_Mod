...
//===========================================================================
/*
 * Changed name of the printer
 * deactivated min_software_endstops to allow for manual travel in negative direction
 * activated babystepping in configuration_adv.h
 * reduced acceleration
 * changed Z_RAISE_BEFORE_HOMING from 4 to 1
 * set max_software_endstops to false
*/
...
//#define CUSTOM_MACHINE_NAME "Zweiter"
#define CUSTOM_MACHINE_NAME "Swordfish"
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER 23     // Z probe to nozzle X offset: -left  +right // Kapazitiver Sensor
...
// default settings
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2560,180}  // default steps per unit for M8 z-rod
...
#define ABS_PREHEAT_HOTEND_TEMP 180
