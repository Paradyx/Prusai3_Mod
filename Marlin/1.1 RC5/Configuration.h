 ...
 */
 ...
 /**
 * changed #define HOMING_FEEDRATE - 25.04.2016
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  //    O-- FRONT --+
  //  (0,0)
  #define X_PROBE_OFFSET_FROM_EXTRUDER 23  // X offset: -left  [of the nozzle] +right
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 21  // Y offset: -front [of the nozzle] +behind
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2133.33,180}  // default steps per unit for Ultimaker
